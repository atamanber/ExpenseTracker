...
The app currently supports ABN AMRO and bunq. If your bank is not listed, see [`prompts/add-bank-parser.md`](prompts/add-bank-parser.md) for a ready-to-use Claude Code prompt that walks you through adding a new parser.
